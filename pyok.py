...
def main():
    ...
    if downloads_folder:
        ...
        # Удаление столбца "Решение"
        tree = ttk.Treeview(root, columns=('Совпадения', 'Тег'))
        tree.heading('#1', text='Совпадения', anchor='w')  
        tree.heading('#2', text='Тег', anchor='w')
        tree.column('#1', stretch=True, minwidth=0, width=window_width // 2)
        tree.column('#2', stretch=False, minwidth=0, width=window_width // 8)  # Растягиваем по горизонтали
        tree['show'] = 'headings'
